...
func (e *AESEncryptor) Encrypt(ctx context.Context, text string) (string, error) {
...
func (e *AESEncryptor) Check(ctx context.Context, realString, encryptedString string) (bool, error) {
